...
const EMPLOYEES: Employee[] = [
  { id: 1, displayName: "Аня Смирнова", isAdmin: false, isActive: true, telegramUserId: 10, birthDate: null, address: "Аня", excludedFromAssignment: false, excludedFromSwaps: false },
