...
|---|---|---|
| 1. `different-day` в `validateSwap` | ⬜ следующая | — |
| 2. `swapCandidates` — кто в списке | ⬜ | — |
| 3. Экран: поиск, строки дня, видимый выбор | ⬜ | — |
| 4. `App.tsx` грузит день под смену | ⬜ | — |
| 5. Живая проверка в Chromium и ledger | ⬜ | — |
